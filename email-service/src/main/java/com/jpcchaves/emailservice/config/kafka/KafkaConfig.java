package com.jpcchaves.emailservice.config.kafka;
...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.topic.email-success}")
    private String emailSuccessTopic;

    @Value("${spring.kafka.topic.email-fail}")
    private String emailFailTopic;
